<header>
        ...
        <div id="open_nav">
            ...
            <!-- 내비게이션 -->
            <nav>
                <a href="./product.list.html">선글라스</a>
                <a href="./product.list.html">안경</a>
                <a href="./product.list.html">콜라보레이션</a>
                <a href="./product.list.html">스타일</a>
                <a href="./product.list.html">브랜드이슈</a>
                <a href="./map.html">매장보기</a>
                <a href="./product.list.html">수리서비스</a>
            </nav>
        </div>
    </header>